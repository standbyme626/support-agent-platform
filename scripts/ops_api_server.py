...
from app.application.intake_runtime_service import (
    extract_runtime_trace_fields as extract_runtime_trace_fields_service,
...
from app.application.ticket_runtime_service import (
    build_ticket_assist_payload as build_ticket_assist_payload_service,
    execute_action_without_approval as execute_action_without_approval_service,
    execute_close_compat_action as execute_close_compat_action_service,
    execute_v2_ticket_action as execute_v2_ticket_action_service,
    resolve_action as resolve_action_service,
)
...
def _resolve_action(
    ...
    return resolve_action_service(
        runtime,
        ticket_id=ticket_id,
        action=action,
        body=body,
        ticket_to_dict=_ticket_to_dict,
        ticket_trace_id_getter=_ticket_trace_id,
    )
...
def _execute_action_without_approval(
    ...
    return execute_action_without_approval_service(
        runtime,
        ticket_id=ticket_id,
        action=action,
        payload=payload,
...
def _execute_v2_ticket_action(
    ...
    *,
    ...
    return execute_v2_ticket_action_service(
        runtime,
        ticket_id=ticket_id,
        action=action,
        actor_id=actor_id,
...
def _execute_close_compat_action(
    ...
    *,
    ...
    return execute_close_compat_action_service(
        runtime,
        ticket_id=ticket_id,
        actor_id=actor_id,
        payload=payload,
...
def _extract_runtime_trace_fields(
    ...
    *,
    ...
    return extract_runtime_trace_fields_service(
        result_payload,
...
def _run_intake_graph_v2(
    ...
    *,
    ...
    return run_intake_graph_v2_service(
        runtime,
        payload=payload,
...
def _run_ticket_investigation_v2(
    ...
    *,
    ...
    return run_ticket_investigation_v2_service(
        runtime,
        ticket_id=ticket_id,
        payload=payload,
        ticket_trace_id_getter=_ticket_trace_id,
...
def _build_ticket_assist_payload(runtime: OpsApiRuntime, ticket_id: str) -> dict[str, Any]:
    return build_ticket_assist_payload_service(
        runtime,
        ticket_id,
        extract_llm_trace_for_ticket=_extract_llm_trace_for_ticket,
        normalize_llm_trace=_normalize_llm_trace,
