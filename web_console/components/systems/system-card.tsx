...
const STATUS_LABELS: Record<string, { zh: string; en: string }> = {
  ...
  procurement: { zh: "采购中", en: "Procurement" },
  ...
  preboarding: { zh: "预入职", en: "Pre-boarding" },
  submitted: { zh: "已提交", en: "Submitted" },
  profile_created: { zh: "档案已建", en: "Profile Created" },
  provisioning: { zh: "配置中", en: "Provisioning" },
};

const ACTION_LABELS: Record<string, { zh: string; en: string }> = {
  request: { zh: "申请", en: "Request" },
  receive: { zh: "收货", en: "Receive" },
  ...
  submit_review: { zh: "提交审核", en: "Submit Review" },
  publish: { zh: "发布", en: "Publish" },
  expire: { zh: "标记过期", en: "Mark Expire" },
  archive: { zh: "归档", en: "Archive" },
  update: { zh: "更新", en: "Update" },
  set_pending: { zh: "设为待定", en: "Set Pending" },
  resume: { zh: "恢复", en: "Resume" },
  work_on: { zh: "开始处理", en: "Work On" },
  ...
  send_offer: { zh: "发送offer", en: "Send Offer" },
  submit: { zh: "提交", en: "Submit" },
  approve: { zh: "批准", en: "Approve" },
  reject: { zh: "拒绝", en: "Reject" },
  create_profile: { zh: "建档案", en: "Create Profile" },
};
