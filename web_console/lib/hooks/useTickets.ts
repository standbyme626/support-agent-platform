...
function initialFilters(): TicketFilters {
  ...
  if (Array.from(params.keys()).length > 0) {
    return {
      ...
      community_name: params.get("community_name") ?? undefined,
      building: params.get("building") ?? undefined,
      parking_lot: params.get("parking_lot") ?? undefined,
      approval_required: params.get("approval_required") ?? undefined,
